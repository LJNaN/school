...
const resourceUseageData = [
  {
    ...
    today: "1.235",
    total: "1.235",
    url: "/assets/2d/img/音频文件2@2x.png",
  },
  {
    name: "文档文件",
    today: "1.235",
    total: "1.235",
    url: "/assets/2d/img/文档文件2@2x.png",
  },
  {
    name: "教学活动",
    today: "1.235",
    total: "1.235",
    url: "/assets/2d/img/教学活动2@2x.png",
  },
];
//7日学习记录数据
  ...
  <div class="right">
    <Container title="教学楼教师使用情况">
      ...
      <div class="teacherUsage">
        <img src="/assets/2d/img/组17@2x.png" />
  ...
  .learningRecord {
    .title {
      ...
      li {
        ...
        gap: vh(7);
        background: url("/assets/2d/img/组1649@2x.png");
    ...
    .totalData {
      ...
      li {
        ...
        p::before {
          ...
          height: vh(6);
          margin-right: vw(10);
          background: url("/assets/2d/img/多边形 5@2x.png");
          background-size: 100% 100%;
        }
        p::after {
          content: "";
          ...
          height: vh(18);
          margin-left: vw(10);
          background: url("/assets/2d/img/组 1649@2x(1).png");
          background-size: 100% 100%;
        }
