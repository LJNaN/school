...
const monitorData = [
  {
    id: "01",
    name: "北门安保室",
    url: "./assets/2d/img/smartEducationInner/6.png",
  },
  {
    id: "02",
    name: "南门安保室",
      ...
      <div class="equipmentAdjustment">
        ...
        <div class="slider">
          <div style="display: flex">
            <img
              :src="'./assets/2d/img/smartEducationInner/7.png'"
              class="icon"
            />
            <div>
              <p>亮度</p>
          ...
          <div style="display: flex">
            <img
              :src="'./assets/2d/img/smartEducationInner/8.png'"
              class="icon"
            />
            <div>
              <p>温度</p>
...
.right {
  ...
  .equipmentSituation {
    ...
    li {
      ...
      &:nth-child(n + 2) {
        background: url("/assets/2d/img/smartEducationInner/9.png");
        background-size: 100% 100%;
      }
    }
  }
  ...
  .monitor {
    ...
    li {
      ...
      .monitorName {
        ...
        justify-content: center;
        align-items: center;
        background: url("/assets/2d/img/smartEducationInner/10.png");
        background-size: 100% 100%;
        :first-child {
          width: 10%;
          margin-left: vw(5);
